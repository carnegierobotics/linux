		...
		struct snd_kcontrol *kcontrol, int event) //CONFIG_LINF
{
	...
	reg = snd_soc_component_read(component, AK4954_01_POWER_MANAGEMENT2);
	nLOSEL = (0x1 & reg);
		...
		unsigned int freq, int dir)
{
	...
	pll= snd_soc_component_read(component, AK4954_05_MODE_CONTROL1);
	pll &=(~0x70);
	pllpwr = snd_soc_component_read(component,AK4954_01_POWER_MANAGEMENT2);
	pllpwr &=(~0x0c);
...
static int ak4954_set_dai_fmt(struct snd_soc_dai *dai, unsigned int fmt)
{
	...
	mode = snd_soc_component_read(component, AK4954_01_POWER_MANAGEMENT2);
	format = snd_soc_component_read(component, AK4954_05_MODE_CONTROL1);
	format &= ~AK4954_DIF;
		...
		enum snd_soc_bias_level level)
{
	...
	case SND_SOC_BIAS_STANDBY:
		reg = snd_soc_component_read(component, AK4954_00_POWER_MANAGEMENT1);	// * for AK4954
