...
#define ETH_RDES1_RBS2(x)			(((x) << 16) & 0x1FFF0000)
#define ETH_RDES1_RBS1(x)			((x) & 0x00001FFF)
...
#define ETH_TDES0_CRCR				0x01000000
#define ETH_TDES0_CIC_V2			0x00C00000
#define ETH_TDES0_CIC_V1			0x00800000
#define ETH_TDES0_CIC_HDR			0x00400000
...
#define ETH_TDES1_SAIC_MAC1			0x80000000
#define ETH_TDES1_SAIC_REPLACE			0x40000000
#define ETH_TDES1_SAIC_INCLUDE			0x20000000
#define ETH_TDES1_TBS2(x)			(((x) << 16) & 0x1FFF0000)
#define ETH_TDES1_TBS1(x)			((x) & 0x00001FFF)

/* ==========================================================================*/

#define AMBETH_FC_AUTONEG			(1 << 0)
#define AMBETH_FC_RX				(1 << 1)
#define AMBETH_FC_TX				(1 << 2)
...
#define AMBETH_DEFAULT_BFSIZE			1536
...
struct ambeth_gmac_ops {
	int (*set_mode)(void *priv);
	int (*set_clock)(void *priv);
};

struct ambeth_gmac_offsets {
	u32 ahbsp_ctrl;
	u32 ahbsp_gmii_data;
	u32 ahbsp_gmii_addr;
};

struct ambeth_gmac_soc_data {
	const struct ambeth_gmac_ops *ops;
	const struct ambeth_gmac_offsets *offsets;
};
...
struct ambeth_info {
	...
	const struct ambeth_gmac_ops *soc_ops;
	const struct ambeth_gmac_offsets *soc_offsets;
};
